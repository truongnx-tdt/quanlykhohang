...
namespace PMQuanLyHangTonKho.Views
{
    public partial class frmSupplier : Form
    {
        ...
        string[] columnsValues = new string[] { "Id", "Name", "ContactName", "ContactTitle", "Address", "Phone", "Email", "Website" };
        string[] columnsName = new string[] { "Mã NCC", "Tên NCC", "Tên người liên hệ", "Chức vụ người liên hệ", "Địa chỉ", "Điện thoại", "Email", "Website" };
        string[] columnsSearch = new string[] { "Mã NCC", "Tên NCC", "Tên người liên hệ", "Chức vụ người liên hệ", "Địa chỉ", "Điện thoại", "Email", "Website" };
        int[] width = new int[] { 120, 250, 250, 250, 250,120,120 };
        ...
        private void menuXoa_Click(object sender, EventArgs e)
        {
            ...
            if (isDelete)
            {
                ListEdit.Delete("Supplier", "Id", dtgvMain.Rows[dtgvMain.CurrentCell.RowIndex].Cells[0].Value.ToString());
                LoadData();
            }
        }
        ...
        {
            string KeySearch = "";
            ListEdit.LoadFormSearchList(columnsValues, columnsSearch, new Point(300, 330),out KeySearch);
            LoadData(KeySearch);
        }
